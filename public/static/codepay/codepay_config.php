 ...
 */
$codepay_config['return_url'] = 'http://www.fenfa321.cn/public/static/codepay/notify.php'; //自动生成跳转地址
...
define('DB_USER', 'chaojiqian');  //数据库用户名
define('DB_PWD', 'chaojiqian');//数据库密码
define('DB_NAME', 'chaojiqian');  //数据库名称
