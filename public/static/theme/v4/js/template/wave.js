    ...
    var w = {
        zh: {
            ...
            GO_OUT_WECHAT_IOS_TIP: "<span class=\"span1\">\n" +
                ...
                "            用Safari打开下载\n" +
                "        </span>",
            FOOTER_SLOGAN: 'ios999.com 是应用内测平台，请自行甄别应用风险，<wbr />如应用存在问题，<wbr />可点击“举报”按钮 <a class="one-key-report" href="javascript:;">举报!</a>',
            SAFE: "安全",
            ...
            REALNAME_LAYER_CONTENT: "建议您：<br>尽快登录一口青APP分发网站，点击右上角未实名认证，进行认证。<br>未实名认证，下载链接有效期只有24小时，只能下载5次。",
        ...
        en: {
            ...
            FOOTER_SLOGAN: 'ios999.com provide beta app hosting service. If the app <wbr /> is suspicious, click the "report" button please.<a class="one-key-report" href="javascript:;">Report!</a>',
            SAFE: "Safe",
            ...
            REPORT_THANKS: "Thank you for helping to make ios999.com better!",
            ...
            REALNAME_LAYER_CONTENT: "please go to login to xianfeng APP website，click the button in the upper right corner to authentication。<br />If not , the download link is valid for download only 5 times in 24 hours.",
        ...
        "zh-tw": {
            ...
            FOOTER_SLOGAN: 'ios999.com 是應用內測平台，請自行甄別應用風險，<wbr />如應用存在問題，<wbr />可點擊“舉報”按鈕 <a class="one-key-report" href="javascript:;">舉報!</a>',
            SAFE: "安全",
            ...
            REALNAME_LAYER_CONTENT: "建議您：<br>盡快登錄先鋒APP網站，點擊右上角未實名認證，進行認證。<br>未實名認證，下載鏈接有效期只有24小時，只能下載5次。",
            REALNAME_LAYER_BUTTON_TEXT: "知道了",
            BUTTON_OK: "確定",
    ...
    $(function() {
        window.DAFU = {
                ...
                successVip: function() {
                    ...
                    if (hostname.indexOf('boyoll.com') == -1) {
                ...
                weixin: function() {
                    ...
                    wx.ready(function() {
                        wx.onMenuShareAppMessage({
                            ...
                            link: "https://app.boyoll.com/" + this_app.url,
                ...
                submitPwd: function() {
                    ...
                    // 验证密码是否正确
                    $.getJSON('/source/index/ajax.php?ac=check-password', {
                        url: url,
                        password: password
                    }, function(data) {
                        if (data.code == 200) {
