<?php
return array (
  'ADMIN_ADMININDEX_BAN' => '本站用户拉黑',
  'ADMIN_ADMININDEX_CANCELBAN' => '本站用户启用',
  'ADMIN_ADMININDEX_DEFAULT' => '用户管理',
  'ADMIN_ADMININDEX_DEFAULT1' => '用户组',
  'ADMIN_ADMININDEX_INDEX' => '本站用户',
  'ADMIN_APP_DEFAULT' => '应用管理',
  'ADMIN_APP_INDEX' => '应用列表',
  'ADMIN_CERTIFICATE_INDEX' => '证书管理',
  'ADMIN_DOWNLOAD_INDEX' => '用户下载',
  'ADMIN_DOWNLOAD_SUPINDEX' => '费用管理',
  'ADMIN_DOWNLOAD_SUP_ADD_CHARGE' => '下载明细',
  'ADMIN_FASTLANE_INDEX' => '账户管理',
  'ADMIN_HOOK_INDEX' => '钩子管理',
  'ADMIN_HOOK_PLUGINLISTORDER' => '钩子插件排序',
  'ADMIN_HOOK_PLUGINS' => '钩子插件管理',
  'ADMIN_HOOK_SYNC' => '同步钩子',
  'ADMIN_LEVEL_INDEX' => '代理管理',
  ...
  'ADMIN_MEMBERS_CHARGE' => '充值记录',
  'ADMIN_MEMBERS_CONSUME' => '消费记录',
  'ADMIN_MEMBERS_DEFAULT' => '客户管理',
  'ADMIN_MEMBERS_INDEX' => '客户列表',
  ...
  'USER_ADMIN_INDEX_AUTH_INFO_MANAGE' => '认证信息管理',
);